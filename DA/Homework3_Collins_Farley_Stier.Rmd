...
How many discriminant functions are significant? Relative discriminating power?
...
Because our sample size is so large with 2841 counties, there is not a significant difference noticed when cross-validation is applied. The discriminating ability of the function remains at 54%. The lack of difference wtih cross-validation means that we are likely not overfitting our data.
