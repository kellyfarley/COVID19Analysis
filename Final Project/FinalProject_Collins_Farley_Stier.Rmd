...
plot(euclusters_ward,labels=as.vector(stlogdata[,"County_Name"]),cex=0.1,xlab="",ylab="Distance",lwd=0.2, main="Euclidean Distance & Ward Clustering"); rect.hclust(euclusters_ward, k = 4)
```
...
```{r}
clusplot(stlogdata[,7:15], cuts, color = TRUE, shade = TRUE, labels = 2, lines = 0, main = "County Cluster Plot, Ward's Method, First two PC", cex = .5)
```
