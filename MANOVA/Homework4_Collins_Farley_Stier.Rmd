...
#qqPlot(modnever$residuals)
#qqPlot(modsometimes$residuals)
#qqPlot(modalways$residuals)
plot(modnever, which = c(1,2), pch=19)
plot(modsometimes, which = c(1,2), pch=19)
plot(modalways, which = c(1,2), pch=19)

MASS::boxcox(modnever, optimize=TRUE)
```

We see marked heteroskedasticity in the Never and Sometimes residuals plots. Looks like it's boxcox time!
